...
# Write an ifelse() statement that returns 1 
# if the sex is Female and 2 if the sex is Male.
...
# Write an ifelse() statement that takes the height column and 
# returns the height if it is greater than 72 inches and returns 0 otherwise.
...
# How many individuals in the heights dataset have a 
...
# Done directly on assignment page


# Question 5

# Given an integer x, the factorial of x is called x! 
# and is the product of all integers up to and including x. 
# The factorial() function computes factorials in R. 
